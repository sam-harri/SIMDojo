...
export function ProblemCard({ problem }: { problem: ProblemItem }) {
  return (
    <Link
      ...
      className="group flex items-center gap-3 rounded-xl bg-card px-4 py-3 ring-1 ring-foreground/[0.06] transition-all duration-200 hover:bg-primary/[0.04] hover:ring-primary/30 dark:hover:bg-primary/[0.06]"
    >
